...
# Fix directory listing error
echo "🔧 Fixing directory listing error..."
cp index.html /home/votingonline2025.site/public_html/
cp .htaccess /home/votingonline2025.site/public_html/

# Disable autoindex in Nginx
sed -i 's/#.*autoindex off/autoindex off/' /etc/nginx/sites-available/${DOMAIN}
